...
let body = <div>
  ...
  <p>A response to {l("Please don't learn to code", 'http://techcrunch.com/2016/05/10/please-dont-learn-to-code/')}; plus <em>many</em> online and in-person debates I've had with fellow developers. Code is easy and lucrative, and if you disagree ("that's naive", "that's missing the bigger picture") you are <em>wrong</em>. My argument's strength is first-hand experience.</p>
