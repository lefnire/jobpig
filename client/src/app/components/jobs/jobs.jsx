...
export default class Jobs extends Component {
  ...
  render() {
    ...
    let styles = {
      empty: {fontSize: '1.2em', lineHeight: 1.5}
    };
      ...
      <mui.Card style={{margin:40}}>
        {
          filter === 'liked'?
            <mui.CardText>
              <p style={styles.empty}>Your liked page will be filled with jobs that you have liked. You can use this page to keep track of jobs you
          ...
          : filter === 'disliked'?
            <mui.CardText styles={styles.empty}>
          ...
          :
            <mui.CardText>
              <div style={styles.empty}>
                <p> Your appied job page will be filled with jobs that you have applied to.
